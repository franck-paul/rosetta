...
class Install
{
    ...
    public static function process(): bool
    {
        ...
        try {
            ...
            $struct->table(CoreData::ROSETTA_TABLE_NAME)
                ...
                ->index('idx_rosetta_src_id', 'btree', 'src_id')
                ->index('idx_rosetta_dst_id', 'btree', 'dst_id')

                // Direct association indexes helpers
                ->index('idx_rosetta_src_id_dst_lang', 'btree', 'src_id', 'dst_lang')
                ->index('idx_rosetta_dst_id_src_lang', 'btree', 'dst_id', 'src_lang')

                // Indirect association indexes helpers
                ->index('idx_rosetta_src_id_src_lang', 'btree', 'src_id', 'src_lang')
                ->index('idx_rosetta_dst_id_dst_lang', 'btree', 'dst_id', 'dst_lang')
            ;

            $struct->table(CoreData::ROSETTA_TABLE_NAME)
                ->reference('fk_rosetta_src', 'src_id', App::blog()::POST_TABLE_NAME, 'post_id', 'cascade', 'cascade');
            $struct->table(CoreData::ROSETTA_TABLE_NAME)
                ->reference('fk_rosetta_dst', 'dst_id', App::blog()::POST_TABLE_NAME, 'post_id', 'cascade', 'cascade');
